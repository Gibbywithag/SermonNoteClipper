...
export default function Gallery() {
    ...
    if (loading) {
        return (
            <div className="h-full flex flex-col items-center justify-center text-muted animate-[fadeIn_0.5s_ease-out]">
        ...
        return (
            <div className="h-full flex flex-col items-center justify-center text-red-600 p-6">
                ...
                <button
                    ...
                    className="mt-4 px-4 py-2 bg-stone hover:bg-line/60 rounded-lg text-sm text-ink transition-colors"
                >
                    Retry
                </button>
            </div>
    ...
    return (
        <div className="h-full overflow-y-auto p-6 md:p-8 animate-[fadeIn_0.3s_ease-out]">
            <div className="flex items-center justify-between mb-8">
                <h1 className="font-display italic text-3xl flex items-center gap-3">
                    <LayoutGrid className="text-primary" /> Clip Gallery
                </h1>
                <span className="text-xs bg-stone text-ink px-3 py-1 rounded-full border border-line">
